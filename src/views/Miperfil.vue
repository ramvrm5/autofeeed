<template>
  <div class="container-fluid">
    ...
    <b-row style="height: 65vh !important;width:100%" class="align-items-center">
      <b-col class="col-11 col-sm-11 col-md-11 col-lg-11 vh-50 mx-auto">
        <form
          ...
          "
        >
          <div class="input-group mt-2 mb-2 mr-sm-2 col-12 col-sm-12 col-md-12 col-lg-12">
            <img
              style="
                max-width: 180px;
                border-radius: 15px;
          ...
          <div class="input-group mt-2 mb-2 mr-sm-2 col-12 col-sm-12 col-md-4 col-lg-3">
          ...
          <div class="input-group mt-2 mb-2 mr-sm-2 col-12 col-sm-12 col-md-3 col-lg-3">
            <div class="input-group-prepend">
...
export default {
  ...
  methods: {
    ...
    getlanguage(){
      store.commit("setSelectedLan", document.getElementById("selectedLanid").value);
  ...
  computed: {
    ...
    ...mapState(["usuario", "nombre", "apellidos","selectedLan", "tags", "alerta", "items2"]),
  },
};
</script>

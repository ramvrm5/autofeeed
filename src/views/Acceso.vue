...
<div>
 ...
 <div class="loginpc" style="margin-top:10vh;position:relative;margin-left:auto;margin-right:auto;">
        <!--<h1 style="text-align:center">Bienvenido</h1>-->
        <img class="imagenlogin" style="width:100%" src="../assets/logoblanco.png">
      ...
      <b-form-group  style="color:white !important;text-shadow: 1px 1px 3px #000000;" id="input-group-2" label="Contraseña:" label-for="input-2">
        <b-form-input
          id="input-2"
          v-model="pass"
          type="password"
       ...
       <!--
            ...
            <input 
                ...
                v-model="pass"
            >-->
             <b-button type="submit" variant="primary" :disabled='!desactivar'>Acceder</b-button>
      <b-button type="reset"  style="color:white;margin-left: 1em;border-color: green;background-color: green;"><router-link style="color:white" to="/registro" >Registrarse</router-link></b-button>
        ...
        <!--error.code dice el codigo de error para traducciones -->
          ...
          <p @click="cambiarcontraseña({email})" style="position: fixed; right: 18px;bottom: 5px;">Recuperar contraseña</p>
      


       
    </div>
      <img src="../assets/fondoc1.jpg"  id="fondoid" class="fondopc" style="    position: absolute; top: 0px;height: 100%;object-fit: cover;z-index: -1; width: 100%;">
